...
const mainImageStyle = { width: "100%", height: "480px", objectFit: "contain", objectPosition: "center", padding: "12px", borderRadius: "18px", display: "block", background: "#fff" };
...
const thumbImage = { width: "100%", height: "84px", objectFit: "contain", objectPosition: "center", padding: "4px", display: "block", background: "#fff" };
