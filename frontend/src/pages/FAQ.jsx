...
const faqContent = {
  tr: {
    ...
    items: [
      ...
      { id: "unilevel-example", category: "earning", q: "Unilevel oranlarına göre örnek kazanç ne kadardır?", a: "3.599 TL ilk lisans dağıtım tabanında örnek tutarlar şöyledir: 1. seviye %50 = 1.799,50 TL; 2. seviye %10 = 359,90 TL; 3. seviye %5 = 179,95 TL; 4. seviye %3 = 107,97 TL; 5, 6 ve 7. seviyelerin her biri %2 = 71,98 TL; 8, 9 ve 10. seviyelerin her biri %1 = 35,99 TL. On seviyenin tamamında uygun hak sahibi varsa toplam örnek dağıtım 2.771,23 TL'dir. Her kişi yalnızca kariyerinin açtığı derinlik ve aktif lisans şartı kadar kazanır." },
      { id: "matrix-earning", category: "earning", q: "Aylık eğitim bedelindeki Matrix kazancı nasıl oluşur?", a: "İlk lisans sonrasındaki 799 TL aylık eğitim bedelinde Unilevel dağıtımı yapılmaz. Eğitim bedelinin %3'ü Matrix hattında kariyerin izin verdiği derinliğe kadar her uygun aktif lisanslı üyeye ayrı ayrı yansır. Başlangıç 12, Bronz ve Gümüş 13, Altın ve Platin 14, Elmas ve Taç Elmas 15 Matrix seviyesine kadar hak açar." },
      { id: "matrix-example", category: "earning", q: "Matrix oranına göre örnek kazanç ne kadardır?", a: "799 TL aylık eğitim paketinin %3'ü yaklaşık 23,97 TL'dir. 2x15 Matrix tam dolu olduğunda bir kişinin altında 1. derinlikte 2, 2. derinlikte 4, 3. derinlikte 8, 4. derinlikte 16, 5. derinlikte 32 kişi bulunur ve sayı her derinlikte iki katına çıkar. Yalnızca o ay eğitim paketini satın alıp ödemesi onaylanan uygun kişiler hesaba katılır. Buna göre ilk 5 derinlikteki yaklaşık kazançlar ayrı ayrı 47,94 TL, 95,88 TL, 191,76 TL, 383,52 TL ve 767,04 TL'dir. Kariyeri 12 derinliğe kadar kazanç hakkı açan bir kişinin altında tüm pozisyonlar dolu ve 8.190 kişinin tamamının eğitim paketi ödenmişse teorik toplam yaklaşık 196.314,30 TL olur. Tam dolulukta 13 derinlikte 16.382 kişi için yaklaşık 392.676,54 TL; 14 derinlikte 32.766 kişi için yaklaşık 785.401,02 TL; 15 derinlikte 65.534 kişi için yaklaşık 1.570.849,98 TL oluşur. Bunlar garanti kazanç değil, tam doluluk ve tüm eğitim paketi ödemelerinin onaylanması varsayımıyla verilmiş teorik örneklerdir; boş, ödenmemiş, pasif veya şartları sağlamayan üyelerden kazanç doğmaz." },
      { id: "product-profit-base", category: "earning", q: "Ürün satış kazancının hesaplama tabanı nedir?", a: "Yalnızca Ödendi olarak onaylanan fiziki ürün siparişleri hesaplanır. Dağıtım; satış fiyatı veya normal ve lisanslı fiyat arasındaki fark üzerinden değil, ürün ve satış masrafları çıktıktan sonra yönetim tarafından üründe tanımlanan dağıtıma esas net kâr üzerinden yapılır. Bu tutar sipariş oluşturulurken kayda alınır." },
      { id: "normal-product-earning", category: "earning", q: "Normal fiyatlı ürün satışında net kâr nasıl paylaşılır?", a: "Dağıtıma esas net kârın %25'i müşteriyi sisteme kaydeden doğrudan sponsora verilir. Diğer %25 sponsor hattında yukarı doğru, Ünilevel mantığıyla 2-10. seviyelere %5, %5, %3,75, %2,50, %2,50, %2,50, %1,25, %1,25 ve %1,25 oranlarında dağıtılır. Kalan %50 şirkette kalır. Kazanacak kişinin aktif lisanslı olması ve kariyerinin ilgili derinliği açması gerekir; şartı sağlamayan pay başka bir kişiye aktarılmaz." },
      { id: "normal-product-example", category: "earning", q: "Normal ürün satışı için örnek kazanç dağılımı nedir?", a: "Masraflar sonrası kabul edilen net kâr 1.000 TL ise doğrudan sponsor 250 TL alır. Üst sponsorların payları sırasıyla 50 TL, 50 TL, 37,50 TL, 25 TL, 25 TL, 25 TL, 12,50 TL, 12,50 TL ve 12,50 TL'dir; üst sponsor havuzu toplam 250 TL'dir. Tüm hak sahipleri uygunsa şirkette 500 TL kalır." },
      { id: "licensed-product-earning", category: "earning", q: "İndirimli/lisanslı ürün satışında net kâr nasıl paylaşılır?", a: "Dağıtıma esas net kârın toplam %10'u sponsor hattında yukarı doğru, Ünilevel mantığıyla 10 seviyeye %5, %1, %1, %0,75, %0,50, %0,50, %0,50, %0,25, %0,25 ve %0,25 olarak dağıtılır. Kalan %90 şirkette kalır. Aktif lisans ve kariyer derinliği şartları aynen uygulanır; sıkıştırma yapılmaz." },
      { id: "licensed-product-example", category: "earning", q: "İndirimli ürün satışı için örnek kazanç dağılımı nedir?", a: "Masraflar sonrası kabul edilen net kâr 1.000 TL ise sponsor hattındaki örnek paylar 50 TL, 10 TL, 10 TL, 7,50 TL, 5 TL, 5 TL, 5 TL, 2,50 TL, 2,50 TL ve 2,50 TL'dir. Uygun hak sahiplerine toplam 100 TL dağıtılır ve 900 TL şirkette kalır." },
  ...
  en: {
    ...
    items: [
      ...
      { id: "earning-types", category: "earning", q: "Which earning types are available?", a: "Movements are separated into initial-license Unilevel earnings, Matrix earnings from later 799 TL monthly training fees, and eligible physical-product sales earnings. Each movement shows its source, depth and amount in Earnings." },
      ...
      { id: "unilevel-example", category: "earning", q: "What is an example Unilevel earning calculation?", a: "Using the 3,599 TL initial-license base: depth 1 at 50% is 1,799.50 TL; depth 2 at 10% is 359.90 TL; depth 3 at 5% is 179.95 TL; depth 4 at 3% is 107.97 TL; depths 5, 6 and 7 at 2% are 71.98 TL each; and depths 8, 9 and 10 at 1% are 35.99 TL each. If all ten depths have eligible beneficiaries, the example total is 2,771.23 TL." },
      { id: "matrix-earning", category: "earning", q: "How do monthly training-fee Matrix earnings work?", a: "Later 799 TL monthly training fees do not create Unilevel earnings. Three percent is credited separately along the Matrix line to eligible active licensed users: Starter up to 12, Bronze/Silver 13, Gold/Platinum 14 and Diamond/Crown Diamond 15 Matrix levels." },
      { id: "matrix-example", category: "earning", q: "What is an example Matrix earning calculation?", a: "Three percent of the 799 TL monthly training package is approximately 23.97 TL. In a completely filled 2x15 Matrix, one member has 2 people at depth 1, 4 at depth 2, 8 at depth 3, 16 at depth 4 and 32 at depth 5, with the count doubling at every depth. Only eligible members whose training-package payment is approved for that month are counted. The approximate earnings from the first five depths are therefore 47.94 TL, 95.88 TL, 191.76 TL, 383.52 TL and 767.04 TL respectively. If every position is filled and all 8,190 people through depth 12 have paid for the training package, the theoretical total for one qualified member is approximately 196,314.30 TL. The corresponding full-tree examples are approximately 392,676.54 TL for 16,382 people through depth 13, 785,401.02 TL for 32,766 people through depth 14 and 1,570,849.98 TL for 65,534 people through depth 15. These figures are theoretical examples, not guaranteed income; empty, unpaid, inactive or otherwise ineligible positions generate no earnings." },
      { id: "product-profit-base", category: "earning", q: "What is the calculation base for product-sale earnings?", a: "Only Paid physical orders qualify. Distribution is based on the accepted net profit configured by management after product and selling expenses, not on the selling price or the gap between normal and licensed prices. This value is snapshotted when the order is created." },
      { id: "normal-product-earning", category: "earning", q: "How is net profit shared on a normal-price sale?", a: "The direct sponsor who registered the buyer receives 25% of accepted net profit. Another 25% is distributed upward at depths 2-10 using 5%, 5%, 3.75%, 2.5%, 2.5%, 2.5%, 1.25%, 1.25% and 1.25%. The company retains 50%. Active-license and career-depth conditions apply, with no compression." },
      { id: "normal-product-example", category: "earning", q: "What is an example normal-price product distribution?", a: "For 1,000 TL accepted net profit, the direct sponsor receives 250 TL. The upper-depth amounts are 50, 50, 37.50, 25, 25, 25, 12.50, 12.50 and 12.50 TL, totaling 250 TL. If all beneficiaries qualify, the company retains 500 TL." },
      { id: "licensed-product-earning", category: "earning", q: "How is net profit shared on a discounted/licensed sale?", a: "Ten percent of accepted net profit is distributed upward using 5%, 1%, 1%, 0.75%, 0.5%, 0.5%, 0.5%, 0.25%, 0.25% and 0.25%. The company retains 90%. Active-license and career-depth conditions apply, with no compression." },
      { id: "licensed-product-example", category: "earning", q: "What is an example discounted product distribution?", a: "For 1,000 TL accepted net profit, the ten example depth amounts are 50, 10, 10, 7.50, 5, 5, 5, 2.50, 2.50 and 2.50 TL. The eligible network receives 100 TL in total and the company retains 900 TL." },
