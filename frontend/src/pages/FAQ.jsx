...
const faqContent = {
  tr: {
    ...
    items: [
      ...
      { id: "matrix-example", category: "earning", q: "Matrix oranına göre örnek kazanç ne kadardır?", a: "799 TL aylık eğitim bedelinin %3'ü 23,97 TL'dir. Matrix hattındaki her uygun aktif ve lisanslı üst kullanıcı kendi açık derinliğinde 23,97 TL kazanır. Örneğin 12 uygun seviye varsa toplam 287,64 TL; 13 seviye varsa 311,61 TL; 14 seviye varsa 335,58 TL; 15 seviye varsa 359,55 TL dağıtılır. Bu toplam tek kişiye değil, ilgili seviyelerdeki uygun kullanıcılara ayrı ayrı yansır." },
  ...
  en: {
    ...
    items: [
      ...
      { id: "matrix-example", category: "earning", q: "What is an example Matrix earning calculation?", a: "Three percent of the 799 TL monthly training fee is 23.97 TL. Each eligible active licensed upline receives 23.97 TL at their qualifying depth. The example totals are 287.64 TL across 12 eligible levels, 311.61 TL across 13, 335.58 TL across 14, and 359.55 TL across 15. These totals are shared among the eligible users rather than paid to one person." },
